...
TEST_CASE_NAMES = [
    ...
    "sel_get_URL",
    "sel_login",
    "sel_loan_request_down_button",
    "sel_continue_button",
    "sel_Upload_identity_documents",
    "sel_Residence_documents",
    "sel_loan_request_top_button",
    "sel_primary_info_page",
    "sel_cross_button",
    "sel_is_credit_approved",
    "sel_credit_rank_page",
    "sel_gurantee_page",
    "sel_Upload_job_documents_page",
    "sel_login_and_navigate",
    "sel_identity_documents_page",
    "sel_Residence_documents_page",
    "sel_loan_info_last_page"
]
